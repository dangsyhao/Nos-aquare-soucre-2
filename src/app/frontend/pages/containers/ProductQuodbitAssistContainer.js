...
class ProductQuodbitTaggingContainer extends Component {
    static getStores() {
        return [
            _pageContainerStore,
        ];
                                ...
                                <div className="justify-content-center mt-5 row">
                                    <div className="text-center col-md-7 col-lg-7" style={{ paddingTop: 100 }}>
                                        <div className="title-heading mt-0 mt-md-5 mt-4 mt-sm-0 pt-2 pt-sm-0">
                                            ...
                                            <h2 className="heading mb-3" style={{ fontSize: 40 }}>Quodbit Assist</h2>
                                            <p className="para-desc text-muted">In IDE Assistant, that filter relevant piece of information based on source code developers are reading</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default Container.create(ProductQuodbitTaggingContainer);
