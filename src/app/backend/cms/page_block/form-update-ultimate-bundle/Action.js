...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'images':              new ImageFieldActionHelper(this.dispatcher, this.formId, 'images'),
            ...
            'list':                new ListFieldActionHelper(this.dispatcher, this.formId, 'list'),
            'ecwidProductId':      new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'ecwidProductId'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('images').dispatchChangeValue(parameters.images)
                    _this.helper('list').dispatchChangeValue(parameters.list)
                    ...
                    _this.helper('ecwidProductId').dispatchChangeValue(parameters.ecwidProductId)
