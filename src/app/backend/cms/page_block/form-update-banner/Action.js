...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'subtitle':            new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'subtitle'),
            'button1Text':         new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'button1Text'),
            'button1Url':          new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'button1Url'),
            'button2Text':         new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'button2Text'),
            'button2Url':          new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'button2Url'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('subtitle').dispatchChangeValue(parameters.subtitle)
                    _this.helper('button1Text').dispatchChangeValue(parameters.button1Text)
                    _this.helper('button1Url').dispatchChangeValue(parameters.button1Url)
                    _this.helper('button2Text').dispatchChangeValue(parameters.button2Text)
                    _this.helper('button2Url').dispatchChangeValue(parameters.button2Url)
