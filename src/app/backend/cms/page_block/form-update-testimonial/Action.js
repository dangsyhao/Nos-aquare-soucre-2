...
import TestimonialFieldActionHelper from './testimonial_field/ActionHelper';
...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'testimonials':        new TestimonialFieldActionHelper(this.dispatcher, this.formId, 'testimonials'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('testimonials').dispatchChangeValue(parameters.testimonials)
