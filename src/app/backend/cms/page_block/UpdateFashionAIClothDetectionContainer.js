...
import FormView from './form-update-fashion-ai-cloth-detection/View';
import FormStore from './form-update-fashion-ai-cloth-detection/Store';
import FormAction from './form-update-fashion-ai-cloth-detection/Action';
