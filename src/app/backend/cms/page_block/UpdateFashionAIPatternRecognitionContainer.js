...
import FormView from './form-update-fashion-ai-pattern-recognition/View';
import FormStore from './form-update-fashion-ai-pattern-recognition/Store';
import FormAction from './form-update-fashion-ai-pattern-recognition/Action';
