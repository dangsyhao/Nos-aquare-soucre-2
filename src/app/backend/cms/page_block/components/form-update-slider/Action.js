...
import SliderFieldActionHelper from './slider_field/ActionHelper';
...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'sliders':             new SliderFieldActionHelper(this.dispatcher, this.formId, 'sliders'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('sliders').dispatchChangeValue(parameters.sliders)
