...
import StepFieldActionHelper from './step_field/ActionHelper';
...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'steps':               new StepFieldActionHelper(this.dispatcher, this.formId, 'steps'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('steps').dispatchChangeValue(parameters.steps)
