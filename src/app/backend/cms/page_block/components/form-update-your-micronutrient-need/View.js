...
import TextFieldView from './text_field/View';
            ...
            <BlockUi tag="div" blocking={this.props.form.get('isBlocked')}>
                <form className="form" onSubmit={e => e.preventDefault()}>
                    <div>
                        ...
                        <h5>YOUR MICRONUTRIENT NEED</h5>
                        <div className="form-group">
                            <label className="control-label">Title Left</label>
                            <LibraryForm.Common.Textbox.View
                                data={this.props.form.get('fields').get('titleLeft')}
                                action={this.props.action}
                            />
                        </div>
                        <h5>IMAGE LISTING</h5>
                        <div className="form-group">
                            <ImageFieldView
                                data={this.props.form.get('fields').get('image')}
                                action={this.props.action}
                            />
                        </div>
                        <h5>TEXT LISTING</h5>
                        <div className="form-group">
                            <TextFieldView
                                data={this.props.form.get('fields').get('text')}
                                action={this.props.action}
                            />
                        </div>
                        ...
                        <div className="form-group">
                            <label className="control-label">Title Right</label>
                            <LibraryForm.Common.Textbox.View
                                data={this.props.form.get('fields').get('titleRight')}
                                action={this.props.action}
                            />
                        </div>
                        <div className="form-group">
                            <label className="control-label">Text Right</label>
                            <LibraryForm.Common.Textbox.View
                                data={this.props.form.get('fields').get('textRight')}
                                action={this.props.action}
                            />
                        </div>
                        <div className="form-group">
