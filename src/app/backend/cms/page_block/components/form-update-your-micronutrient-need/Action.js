...
import ImageFieldActionHelper from './image_field/ActionHelper';
import TextFieldActionHelper from './text_field/ActionHelper';
...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'image':               new ImageFieldActionHelper(this.dispatcher, this.formId, 'image'),
            'text':                new TextFieldActionHelper(this.dispatcher, this.formId, 'text'),
            'titleLeft':           new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'titleLeft'),
            'titleRight':          new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'titleRight'),
            'textRight':           new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'textRight'),
            'buttonText':          new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'buttonText'),
            'buttonLink':          new LibraryForm.Common.Textbox.ActionHelper(this.dispatcher, this.formId, 'buttonLink'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('titleLeft').dispatchChangeValue(parameters.titleLeft)
                    _this.helper('image').dispatchChangeValue(parameters.image)
                    _this.helper('text').dispatchChangeValue(parameters.text)
                    _this.helper('titleRight').dispatchChangeValue(parameters.titleRight)
                    _this.helper('textRight').dispatchChangeValue(parameters.textRight)
                    _this.helper('buttonText').dispatchChangeValue(parameters.buttonText)
                    _this.helper('buttonLink').dispatchChangeValue(parameters.buttonLink)
