            ...
            <BlockUi tag="div" blocking={this.props.form.get('isBlocked')}>
                <form className="form" onSubmit={e => e.preventDefault()}>
                    <div>
                        ...
                        <div className="form-group">
                            <label className="control-label">List text left</label>
                            <ListFieldView
                                data={this.props.form.get('fields').get('list_text_left')}
                                action={this.props.action}
                            />
                        </div>
                        <div className="form-group">
                            <label className="control-label">List text right</label>
                            <ListFieldView
                                data={this.props.form.get('fields').get('list_text_right')}
                                action={this.props.action}
                            />
                        </div>
                    </div>
