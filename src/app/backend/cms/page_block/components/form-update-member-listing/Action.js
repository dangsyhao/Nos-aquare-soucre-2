...
import MemberFieldActionHelper from './member_field/ActionHelper';
...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'members':             new MemberFieldActionHelper(this.dispatcher, this.formId, 'members'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('members').dispatchChangeValue(parameters.members)
