...
import PageListFieldActionHelper from './page_list_field/ActionHelper';
...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'pages':               new PageListFieldActionHelper(this.dispatcher, this.formId, 'pages'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('pages').dispatchChangeValue(parameters.pages)
