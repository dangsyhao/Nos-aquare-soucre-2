...
import FormView from './form-update-fashion-ai-category-classification/View';
import FormStore from './form-update-fashion-ai-category-classification/Store';
import FormAction from './form-update-fashion-ai-category-classification/Action';
