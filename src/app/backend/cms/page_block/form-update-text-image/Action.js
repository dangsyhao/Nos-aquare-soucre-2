...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'layout':              new LibraryForm.Common.Select.ActionHelper(this.dispatcher, this.formId, 'layout'),

            'text':                new LibraryForm.Common.Textarea.ActionHelper(this.dispatcher, this.formId, 'text'),
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('layout').dispatchChangeValue(parameters.layout)
                    _this.helper('layout').dispatchSetChoices([
