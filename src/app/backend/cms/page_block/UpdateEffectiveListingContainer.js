...
import FormView from './form-update-effective-listing/View';
import FormStore from './form-update-effective-listing/Store';
import FormAction from './form-update-effective-listing/Action';
...
class UpdateEffectiveListingContainer extends Component {
    static getStores() {
        return [
            _pageContainerStore,
            _formStore,
...
export default Container.create(UpdateEffectiveListingContainer);
