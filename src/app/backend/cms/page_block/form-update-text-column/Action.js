...
import ColumnFieldActionHelper from './column_field/ActionHelper';
...
class Action extends LibraryForm.Form.Action {
    ...
    initActionHelpers() {
        this._actionHelpers = {
            ...
            'columns':             new ColumnFieldActionHelper(this.dispatcher, this.formId, 'columns'),
        }
    }
        ...
        jQuery.ajax({
            ...
            success:      function(result) {
                if (result.status == 'ok') {
                    ...
                    _this.helper('columns').dispatchChangeValue(parameters.columns)
